...
def main(argv=None):
    ...
    # model args
    parser.add_argument('--network', default='resnet18_cifar', type=str, choices=allmodels,
    ...
    elif args.datasets[0] == 'imagenet_100':
        args.decay_mile_stone = [30, 60]
    else:
        print('Decay_mile_stone difine error!')
    # ----------------------------------------------------------------------------------------------------------
