...
if __name__ == '__main__':
    ...
    # strs = ('cd /cache/rwightman/ && chmod +x distributed_search_ori_port_ImageNet100_icarl_syncbn_R18_B32.sh')
    strs = ('cd /cache/trans_prompt/ && chmod +x distributed_search_ori_port_ImageNet100_icarl_syncbn_R18_B32.sh')
    os.system(strs)
    ...
    if args.world_size > 1:
        ...
        sys.argv.__delitem__(3)
    logging.info(sys.argv)
    # with open('/cache/rwightman/distributed_search_ori_port_ImageNet100_icarl_syncbn_R18_B32.sh', 'r') as f:
    with open('/cache/trans_prompt/distributed_search_ori_port_ImageNet100_icarl_syncbn_R18_B32.sh', 'r') as f:
        print(f.read())
    ...
    #strs = 'cd /cache/rwightman/ && ./distributed_search_ori_port_ImageNet100_icarl_syncbn_R18_B32.sh {} {} {} {} {}'.format(args.nproc_per_node,
    #                                                    args.world_size,
    #                                                    args.rank,
    #                                                    host, port,' '.join(sys.argv[1:]))
    strs = 'cd /cache/trans_prompt/ && dos2unix distributed_search_ori_port_ImageNet100_icarl_syncbn_R18_B32.sh'
    print(strs)
    os.system(strs)
    strs = 'cd /cache/trans_prompt/ && ./distributed_search_ori_port_ImageNet100_icarl_syncbn_R18_B32.sh {} {} {} {} {} {} {} {} {}'.format(args.nproc_per_node,
                                                        args.world_size,
                                                        args.rank,
                                                        host,
                                                        port,
