...
class Appr(Inc_Learning_Appr):
    ...
    def train_epoch(self, t, trn_loader):
        ...
        import os
        mox.file.copy_parallel('s3://bucket-6643/niexing/output/C_C1z_Lucir_Decom_Distill_det_br1_C3_50_11_1st128in_exe_A15G1_d/cifar100_icarl_lucir_wo_reservoir_nc_first_50_ntask_11/models', model_path)
