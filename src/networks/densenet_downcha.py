...
__all__ = ['DenseNet', 'densenet121_downcha', 'densenet169_downcha', 'densenet201_downcha', 'densenet161']
...
def densenet121_downcha(pretrained: bool = False, progress: bool = True, **kwargs: Any):
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_.
    """
    return _densenet('densenet121_downcha', 32, (6, 12, 24, 16), 64, pretrained, progress,
                     **kwargs)
...
def densenet169_downcha(pretrained: bool = False, progress: bool = True, **kwargs: Any):
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_.
    """
    return _densenet('densenet169_downcha', 32, (6, 12, 32, 32), 64, pretrained, progress,
                     **kwargs)



def densenet201_downcha(pretrained: bool = False, progress: bool = True, **kwargs: Any):
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_.
    """
    return _densenet('densenet201_downcha', 32, (6, 12, 48, 32), 64, pretrained, progress,
                     **kwargs)
...
if __name__ == "__main__":
    ...
    # model = models.densenet121_downcha(num_classes=100)
    # model = models.densenet169_downcha(num_classes=100)
    model = models.densenet201_downcha(num_classes=100)

    # model = densenet121_downcha(num_classes=100)
    # model = densenet169_downcha(num_classes=100)
    # model = densenet201_downcha(num_classes=100)
