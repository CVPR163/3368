...
__all__ = ['DenseNet', 'densenet121_cifar_downcha', 'densenet169_cifar_downcha', 'densenet201_cifar_downcha', 'densenet161_cifar_downcha']
...
class DenseNet(nn.Module):
    ...
    def __init__(
        ...
        self.features_1 = nn.Sequential(OrderedDict([
            ...
            ("conv0_new_1_2", nn.Conv2d(num_init_features, num_init_features, 3, stride=1, padding=1, bias=False, groups=num_init_features)),
        ...
        self.features_2 = nn.Sequential(OrderedDict([
            ...
            ("conv0_new_2_2", nn.Conv2d(num_init_features, num_init_features, 3, stride=1, padding=1, bias=False, groups=num_init_features)),
        ...
        self.c_avgpool = Channel_Max_Pooling((1, 4), (1, 4))
    ...
    def get_features(self, x, pod_w, pod_h, branch_model):
        ...
        for item in branch_model._modules.items():
            ...
            if "denseblock" in item[0] or 'relu0' in item[0]:
                ...
                x_w = self.c_avgpool(x_w)
                # import pdb
                # pdb.set_trace()
                x_h = self.h_avgpool(x)
                x_h = self.c_avgpool(x_h)
                pod_w.append(x_w)
                pod_h.append(x_h)
...
def densenet121_cifar_downcha(pretrained: bool = False, progress: bool = True, **kwargs: Any):
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_.
    """
    return _densenet('densenet121_cifar_downcha', 32, (6, 12, 24, 16), 64, pretrained, progress,
                     **kwargs)
...
def densenet169_cifar_downcha(pretrained: bool = False, progress: bool = True, **kwargs: Any):
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_.
    """
    return _densenet('densenet169_cifar_downcha', 32, (6, 12, 32, 32), 64, pretrained, progress,
                     **kwargs)



def densenet201_cifar_downcha(pretrained: bool = False, progress: bool = True, **kwargs: Any):
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_.
    """
    return _densenet('densenet201_cifar_downcha', 32, (6, 12, 48, 32), 64, pretrained, progress,
                     **kwargs)
...
if __name__ == "__main__":
    ...
    model = densenet121_cifar_downcha(num_classes=100)
    # model = densenet169_cifar_downcha(num_classes=100)
    # model = densenet201_cifar_downcha(num_classes=100)
