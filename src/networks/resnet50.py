...
class ResNetBottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.conv_stem_layers = [
            ...
            ("conv0_new_1_2", nn.Conv2d(self.inplanes, self.inplanes, 7, stride=2, padding=3, bias=False, groups=self.inplanes)),
            ...
            ("conv0_new_2_2", nn.Conv2d(self.inplanes, self.inplanes, 7, stride=2, padding=3, bias=False, groups=self.inplanes)),
...
def resnext50_32x4d(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNetBottleneck:
...
def resnext101_32x8d(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNetBottleneck:
