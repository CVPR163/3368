...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv1_layers = [
            ...
            ("conv1_new_1_2", nn.Conv2d(planes, planes, 3, stride=1, padding=1, bias=False,
                                groups=planes)),
            ...
            ("conv1_new_1_4", nn.Conv2d(planes, planes, 1, stride=1, padding=0, bias=False)),
            ("bn1_new_1_4", nn.BatchNorm2d(planes)),
            ("conv1_new_1_5", nn.Conv2d(planes, planes, 3, stride=stride, padding=1, bias=False,
                                groups=planes)),
            ("bn1_new_1_5", nn.BatchNorm2d(planes)),
            ("conv1_new_1_6", nn.Conv2d(planes, planes, 1, stride=1, padding=0, bias=False)),
            ("bn1_new_1_6", nn.BatchNorm2d(planes)),
            ...
            ("conv1_new_2_2", nn.Conv2d(planes, planes, 3, stride=1, padding=1, bias=False,
                                groups=planes)),
            ...
            ("conv1_new_2_4", nn.Conv2d(planes, planes, 1, stride=1, padding=0, bias=False)),
            ("bn1_new_2_4", nn.BatchNorm2d(planes)),
            ("conv1_new_2_5", nn.Conv2d(planes, planes, 3, stride=stride, padding=1, bias=False,
                                groups=planes)),
            ("bn1_new_2_5", nn.BatchNorm2d(planes)),
            ("conv1_new_2_6", nn.Conv2d(planes, planes, 1, stride=1, padding=0, bias=False)),
            ("bn1_new_2_6", nn.BatchNorm2d(planes)),
        ]
        ...
        self.conv2_layers = [
            ...
            ("conv2_new_1_4", nn.Conv2d(planes, planes, 1, stride=1, padding=0, bias=False)),
            ("bn2_new_1_4", nn.BatchNorm2d(planes)),
            ("conv2_new_1_5", nn.Conv2d(planes, planes, 3, stride=1, padding=1, bias=False,
                                groups=planes)),
            ("bn2_new_1_5", nn.BatchNorm2d(planes)),
            ("conv2_new_1_6", nn.Conv2d(planes, planes, 1, stride=1, padding=0, bias=False)),
            ("bn2_new_1_6", nn.BatchNorm2d(planes)),
            ...
            ("conv2_new_2_4", nn.Conv2d(planes, planes, 1, stride=1, padding=0, bias=False)),
            ("bn2_new_2_4", nn.BatchNorm2d(planes)),
            ("conv2_new_2_5", nn.Conv2d(planes, planes, 3, stride=1, padding=1, bias=False,
                                groups=planes)),
            ("bn2_new_2_5", nn.BatchNorm2d(planes)),
            ("conv2_new_2_6", nn.Conv2d(planes, planes, 1, stride=1, padding=0, bias=False)),
            ("bn2_new_2_6", nn.BatchNorm2d(planes)),
        ]
    ...
    def forward(self, x):
        ...
        # Conv1
        x1 = self.conv1[0:12](x1)
        x2 = self.conv1[12:24](x2)
        ...
        out_conv2_branch1 = self.conv2[0:12](x1)
        out_conv2_branch2 = self.conv2[12:24](x2)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.conv_stem_layers = [
            ...
            ("conv1_new_1_2", nn.Conv2d(self.output_channel, self.output_channel, 3, stride=1, padding=1, bias=False,
            ...
            ("conv1_new_1_4", nn.Conv2d(self.output_channel, self.output_channel, 1, stride=1, padding=0, bias=False)),
            ("bn1_new_1_4", nn.BatchNorm2d(self.output_channel)),
            ("conv1_new_1_5", nn.Conv2d(self.output_channel, self.output_channel, 3, stride=1, padding=1, bias=False,
                                groups=self.output_channel)),
            ("bn1_new_1_5", nn.BatchNorm2d(self.output_channel)),
            ("conv1_new_1_6", nn.Conv2d(self.output_channel, self.output_channel, 1, stride=1, padding=0, bias=False)),
            ("bn1_new_1_6", nn.BatchNorm2d(self.output_channel)),
            # The 2-nd passage for Conv1.
            ...
            ("conv1_new_2_2", nn.Conv2d(self.output_channel, self.output_channel, 3, stride=1, padding=1, bias=False,
                                groups=self.output_channel)),
            ...
            ("conv1_new_2_4", nn.Conv2d(self.output_channel, self.output_channel, 1, stride=1, padding=0, bias=False)),
            ("bn1_new_2_4", nn.BatchNorm2d(self.output_channel)),
            ("conv1_new_2_5", nn.Conv2d(self.output_channel, self.output_channel, 3, stride=1, padding=1, bias=False,
                                groups=self.output_channel)),
            ("bn1_new_2_5", nn.BatchNorm2d(self.output_channel)),
            ("conv1_new_2_6", nn.Conv2d(self.output_channel, self.output_channel, 1, stride=1, padding=0, bias=False)),
            ("bn1_new_2_6", nn.BatchNorm2d(self.output_channel)),
        ]
...
def resnet18_cifar_plus(pretrained=False, **kwargs):
...
if __name__ == "__main__":
    ...
    model = resnet18_cifar_plus(pretrained=False)
    # print(model)
