...
__all__ = ['DenseNet', 'densenet121_cifar', 'densenet169_cifar', 'densenet201_cifar', 'densenet161_cifar']
...
def densenet121_cifar(pretrained: bool = False, progress: bool = True, **kwargs: Any):
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_.
    """
    return _densenet('densenet121_cifar', 32, (6, 12, 24, 16), 64, pretrained, progress,
                     **kwargs)
...
def densenet169_cifar(pretrained: bool = False, progress: bool = True, **kwargs: Any):
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_.
    """
    return _densenet('densenet169_cifar', 32, (6, 12, 32, 32), 64, pretrained, progress,
                     **kwargs)



def densenet201_cifar(pretrained: bool = False, progress: bool = True, **kwargs: Any):
    ...
    Args:
        ...
        memory_efficient (bool) - If True, uses checkpointing. Much more memory efficient,
          but slower. Default: *False*. See `"paper" <https://arxiv.org/pdf/1707.06990.pdf>`_.
    """
    return _densenet('densenet201_cifar', 32, (6, 12, 48, 32), 64, pretrained, progress,
                     **kwargs)
...
if __name__ == "__main__":
    ...
    # model = models.densenet121_cifar(num_classes=100)
    # model = models.densenet169_cifar(num_classes=100)
    model = models.densenet201_cifar(num_classes=100)
